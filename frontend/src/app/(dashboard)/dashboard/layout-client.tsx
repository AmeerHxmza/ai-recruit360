  ...
  return (
    <div className="flex h-full flex-col bg-card text-foreground border-r border-border">
      ...
      <div className="flex h-16 items-center border-b border-border px-5 gap-3">
        <div
          className="flex items-center justify-center w-8 h-8 rounded-xl shadow-sm flex-shrink-0 bg-primary"
        >
        ...
        <header className="sticky top-0 z-20 flex h-14 items-center justify-between border-b border-border bg-card/80 backdrop-blur-md px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span
                className="absolute top-1.5 right-1.5 w-1.5 h-1.5 rounded-full ring-1 ring-card bg-primary"
              />
            </Button>
            ...
            <div className="flex items-center gap-3 border-l border-border pl-3 ml-1">
              <div className="text-right hidden sm:block">
                <div className="text-sm font-semibold text-foreground leading-tight">{userProfile.fullName}</div>
                <div className="text-[11px] text-muted-foreground">{userProfile.companyName}</div>
              </div>
